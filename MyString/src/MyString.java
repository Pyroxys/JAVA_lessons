public class MyString {
    ...
    public MyString(char value[]) {
    	// On dit que l'attribut value est un tableau de caractères et 
    	// on regade la taille (length) du tableau pour savoir quelle sera la taille du tableau apres que l'utilisateur est rentré des valeurs 
        this.value = new char[value.length];
        // On demande à aller chercher les valuers qui on était rentré dans le tableau ex : "abc"
