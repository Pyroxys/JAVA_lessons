...
public enum EnumNomBateau {
	...
	public static String[] enumToArray() {
		String[] tableau = { PORTE_AVION.getName(), CROISEUR.getName(), SOUS_MARIN.getName(),
				CONTRE_TORPILLEUR.getName(), TORPILLEUR.getName() };
		return tableau;
	}

	public static EnumNomBateau stringToEnum(String chaine) {
		String enumChaine = chaine.toUpperCase();
		enumChaine = Normalizer.normalize(enumChaine, Normalizer.Form.NFD).replaceAll("[\u0300-\u036F]", "");
